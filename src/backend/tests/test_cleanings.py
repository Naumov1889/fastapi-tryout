...
class TestGetCleaning:
    ...
    async def test_get_all_cleanings_valid_response(
...
class TestUpdateCleaning:
    @pytest.mark.parametrize(
        ...
        (
            ...
            (["name", "description"], ["extra new fake cleaning name",
...
class TestDeleteCleaning:
    ...
    async def test_can_delete_cleaning_with_invalid_id_throws_error(
